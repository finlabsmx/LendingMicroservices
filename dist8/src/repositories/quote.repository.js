...
let QuoteRepository = class QuoteRepository extends repository_1.DefaultCrudRepository {
    constructor(datasource) {
        super(models_1.Quote, datasource);
        this.datasource = datasource;
    }
};
QuoteRepository = __decorate([
    __param(0, core_1.inject('datasources.quoteDS')),
